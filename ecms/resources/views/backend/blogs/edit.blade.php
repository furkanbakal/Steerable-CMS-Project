    ...
    <section class="content-header">
      ...
      {{method_field('PUT')}}
                ...
                <div class="form-group">
                 ...
                 <div class="row">
                 <div class="col-xs-12">
                    <img src="/images/blogs/{{$blogs->blog_file}}" width="100" alt="">
                ...
                <div class="form-group">
                 ...
                 <div class="row">
                 <div class="col-xs-12">
                    <input class="form-control" name="blog_file" required type="file" value="{{$blogs->blog_file}}>
...
<textarea class="form-control" id="editor1" name="blog_content">{{$blogs->blog_title}}</textarea>
<script>
