                ...
                <table class="table table-striped">
                    ...
                    @foreach($data['slider'] as $slider)
                        <tr id="item-{{$slider->id}}">
                           ...
                           <td class="sortable" width="100"><img width="150" src="/images/sliders/{{$slider->slider_file}}" width="100" alt=""></td>
                            ...
                            <a href="javascript:void(0)"><i id="@php echo $slider->id  @endphp" class="fa fa-trash-o"></i></a></td>
                        </tr>
                    @endforeach
                    </tbody>
                    </thead>
