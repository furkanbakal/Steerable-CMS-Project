...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-mini"><b>LOG</b>EDU</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>LOG- </b>EDU</span>
    </a>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active"><a href="{{route('blog.index')}}"><i class="fa fa-paperclip"></i> <span>Blog</span></a></li>
        <li class="active"><a href="{{route('page.index')}}"><i class="fa fa-plane"></i> <span>Page</span></a></li>
        <li class="active"><a href="{{route('slider.index')}}"><i class="fa fa-arrow-right"></i> <span>Slider</span></a></li>
        <li class="active"><a href="{{route('user.index')}}"><i class="fa fa-user"></i> <span>Admin</span></a></li>
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy; 2020 <a href="#">LOG-DEF</a>.</strong> All rights reserved.
  </footer>
